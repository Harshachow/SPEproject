...
app.post('/gamemaster/selection', function(req, res) {
	...
	let sql_round_count = "SELECT COUNT(*) AS no_of_rounds FROM Bidding";
	connection.query(sql_round_count, function(err, results){
		var out = results[0].no_of_rounds/6;
		let groupID = Math.floor(out)+1;
...
app.post('/gamemaster/assignPlayers', function(req,res){
	...
	redisClient.get('currentRound', function(err20, groupIdResp) {
		...
		redisClient.hget("team1",'premLeft',function(err,result){
			if(err) throw err;
		...
		redisClient.hget("team2", 'yourBid', function(err,result){
			if(err) throw err;
			let sql_player_price = "UPDATE Players SET price = ? WHERE team_id = ? AND group_id = ?";
		...
		//PREMIUM INTO DATABASE
		redisClient.hget("team2",'premLeft',function(err,result){
			if(err) throw err;
			let sql_prem_left = "UPDATE Bidders SET premium_left=? WHERE team_id=?";
			connection.query(sql_prem_left,[result,2],function(err2,res2){});
		});

		redisClient.hget("team3", 'yourBid', function(err,result){
			if(err) throw err;
			let sql_player_price = "UPDATE Players SET price = ? WHERE team_id = ? AND group_id = ?";
		...
		//PREMIUM INTO DATABASE
		redisClient.hget("team3",'premLeft',function(err,result){
			if(err) throw err;
			let sql_prem_left = "UPDATE Bidders SET premium_left=? WHERE team_id=?";
			connection.query(sql_prem_left,[result,3],function(err2,res2){});
		});

		redisClient.hget("team4", 'yourBid', function(err,result){
			if(err) throw err;
			let sql_player_price = "UPDATE Players SET price = ? WHERE team_id = ? AND group_id = ?";
		...
		//PREMIUM INTO DATABASE
		redisClient.hget("team4",'premLeft',function(err,result){
			if(err) throw err;
			let sql_prem_left = "UPDATE Bidders SET premium_left=? WHERE team_id=?";
			connection.query(sql_prem_left,[result,4],function(err2,res2){});
		});

		redisClient.hget("team5", 'yourBid', function(err,result){
			if(err) throw err;
			let sql_player_price = "UPDATE Players SET price = ? WHERE team_id = ? AND group_id = ?";
		...
		//PREMIUM INTO DATABASE
		redisClient.hget("team5",'premLeft',function(err,result){
			if(err) throw err;
			let sql_prem_left = "UPDATE Bidders SET premium_left=? WHERE team_id=?";
			connection.query(sql_prem_left,[result,5],function(err2,res2){});
		});

		redisClient.hget("team6", 'yourBid', function(err,result){
			if(err) throw err;
			let sql_player_price = "UPDATE Players SET price = ? WHERE team_id = ? AND group_id = ?";
		...
		//PREMIUM INTO DATABASE
		redisClient.hget("team6",'premLeft',function(err,result){
			if(err) throw err;
			let sql_prem_left = "UPDATE Bidders SET premium_left=? WHERE team_id=?";
